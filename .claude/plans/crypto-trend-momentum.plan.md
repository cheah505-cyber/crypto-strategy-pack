...
### Phase 2 完成门禁
- [ ] 动量因子 IC 分析完成（≥3 个 lookback 窗口）
- [ ] IC 均值 + ICIR + p 值 + 效应量全部报告
- [ ] 前视偏差检查清单逐项通过
- [ ] 交易次数 ≥ 10
- [ ] 回测报告含全部 7 项指标
- [ ] findings.md 追加
...
- [ ] Phase 1 校准完成，VT 在加密上的有效性已量化
- [ ] Phase 2 至少 1 个因子通过 IC 验证（IC > 0.05, p < 0.05）
- [ ] Phase 2 完整回测报告含 7 项指标，交易 ≥ 10 次
- [ ] Phase 3 样本外夏普 ≥ 样本内 50%
- [ ] 所有门禁 git commit 存档
- [ ] Obsidian L1/L2 笔记写入
